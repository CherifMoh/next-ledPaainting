...
const ProductGSkeleton = () => {
  ...
  const skeletonElemnts = myArray.map(num=>(
    <div key={num} className="p-4 rounded">
    <div className="relative h-64 w-64 mb-4 flex justify-center items-center bg-gray-300 animate-pulse">
      <svg
  ...
  console.log(typeof skeletonElemnts)
  return (
