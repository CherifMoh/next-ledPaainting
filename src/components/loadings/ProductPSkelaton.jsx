...
const ProductGSkeleton = () => {
    ...
    const GridElemnts = gridArray.map(num=>(
        <div key={num} className="relative w-28 h-28 mb-4 flex justify-center items-center main-image main-image-on bg-gray-300 animate-pulse">
            <svg
    ...
    return (
        ...
        <section className="product-gallery">
            <div className="main-image-container">
                <div className="relative h-[550px] w-64 mb-4 flex justify-center items-center main-image main-image-on bg-gray-300 animate-pulse">
                    <svg
                            className="w-10 h-10 text-gray-200 dark:text-gray-600"
                            aria-hidden="true"
                            xmlns="http://www.w3.org/2000/svg"
